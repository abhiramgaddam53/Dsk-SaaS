...
// const thClass = "p-2 font-bold text-left text-gray-800 bg-[#f4f7fb] text-[11px]";
// // const tdLabel = "p-2 font-bold bg-[#f4f7fb] text-gray-700 text-[11px] align-top";
// // const tdValue = "p-2 text-[11px] align-top";
// const tblWrap = "border border-black mb-4 bg-white";
// const tblClass = "w-full border-collapse border border-black text-[10px]";
// const trClass = "border-b border-black";
// const tdLabel = "p-1 font-bold bg-gray-50 border-r border-black align-top";
// const tdValue = "p-1 align-top";
...
//         <ValuerFooter pageNum={1} total={9} />
//       </PageShell>
...
//               {/* Classification */}
//               <tr className={trClass}>
//                 <td className={tdLabel} rowSpan={4}>8</td>
...
//               <tr className={trClass}>
//                 <td className={tdLabel} rowSpan={2}>9</td>
...
//         <ValuerFooter pageNum={2} total={9} />
//       </PageShell>
...
//         <ValuerFooter pageNum={3} total={9} />
//       </PageShell>
...
//         <ValuerFooter pageNum={4} total={9} />
//       </PageShell>
...
//         <ValuerFooter pageNum={5} total={9} />
//       </PageShell>
...
//                 <td className={tdValue}></td>
//                 <td className={tdValue}>(-)</td>
//                 <td className={tdValue}>Rs. {F("groundFloorDepreciation")}</td>
...
//         <ValuerFooter pageNum={6} total={9} />
//       </PageShell>
...
//               ))}
//               <tr className={trClass}>
//                 <td className={tdLabel}>Over head water tank</td>
//                 <td className={`${tdValue} text-right`}>
...
//                 <td className={`${tdValue} text-right`}>{F("compoundWallRft")} &nbsp; Rs.{F("compoundWallRate")} Rs/rft &nbsp; Rs. {F("compoundWallValue")}</td>
//               </tr>
//               <tr className={trClass}><td className={tdLabel}>Height</td><td className={tdValue}>{F("compoundWallHeight")}</td></tr>
//               <tr className={trClass}><td className={tdLabel}>Length</td><td className={tdValue}>{F("compoundWallLength")}</td></tr>
...
//         <ValuerFooter pageNum={7} total={9} />
//       </PageShell>
...
//         <ValuerFooter pageNum={8} total={9} />
//       </PageShell>
...
//         <ValuerFooter pageNum={9} total={9} />
//       </PageShell>
//     </>
//   );
// }
