...
import { X, Calendar as CalendarIcon, User, Flag, Clock, MapPin, Trash2 } from 'lucide-react';
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 p-6 overflow-y-auto border-r border-gray-100">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 text-sm text-gray-600"
              />
            </div>
          </div>
          ...
          <div className="w-[320px] bg-gray-50/30 p-6 overflow-y-auto flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-gray-900">60 Mins</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex -space-x-2">
                <div className="w-6 h-6 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center text-[10px] font-bold text-blue-600">P</div>
              </div>
            </div>
          </div>
        </div>
