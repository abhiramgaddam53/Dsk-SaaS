...
import { MoreVertical, ChevronsUpDown, Handshake, PieChart, Banknote, Calendar, Building2 } from 'lucide-react';
...
export default function DealsList({ deals, onStatusChange }: DealsListProps) {
  return (
    <div className="w-full overflow-x-auto rounded-lg border border-gray-200 bg-white">
      <table className="w-full text-sm text-left text-gray-600 whitespace-nowrap table-auto">
      ...
      <div className="flex items-center justify-between px-6 py-3 border-t border-gray-200 bg-white">
        <div className="flex items-center gap-4 text-sm text-gray-500">
          ...
          <span>1 to {deals.length} of 37 results</span>
        </div>
      </div>
    </div>
  );
